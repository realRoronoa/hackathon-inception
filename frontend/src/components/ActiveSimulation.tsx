        ...
        <div className="absolute inset-0 z-20 pointer-events-none flex flex-col justify-between p-6">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            >
              ...
              <span>Exit</span>
              <kbd className="text-[10px] bg-zinc-800/80 px-1.5 py-0.5 rounded text-zinc-400 border border-zinc-700">
                ESC
              </kbd>
            </button>
          ...
          <div className="flex items-end justify-between w-full">
            ...
            <div className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-zinc-950/70 border border-zinc-800/80 backdrop-blur-md text-xs font-mono text-zinc-400 shadow-lg">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`font-semibold uppercase ${
                    activeMovement !== 'idle' ? 'text-emerald-400' : 'text-zinc-500'
                  }`}
                >
                  {activeMovement}
                </span>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`font-semibold uppercase ${
                    activeLook !== 'idle' ? 'text-emerald-400' : 'text-zinc-500'
                  }`}
                >
                  {activeLook}
                </span>
